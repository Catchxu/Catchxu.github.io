...
excerpt: "<em>STANDS</em> is a GAN-based multi-task deep learning framework, which can detect and dissect anomalous tissue domains (DDATD) with Spatial Transcriptomics or scRNA-seq. <br/><br/><img src='/images/DDATD.png' width='60%'><br/>"
